...
public class AsyncCallWSLog extends AsyncTask<String, Void, Void> {
	...
	public AsyncCallWSLog(Activity myContext) {
	...
	private void getCodigoSeguimiento(String tipo_solicitud,
		...
		Log.i("MICROSITIOS", "URL " + Propiedades.webservice
				+ "/solicitudes/solicitud");

		try {
			MultipartEntity reqEntity = new MultipartEntity();
			// MultipartEntity reqEntity = new
			// MultipartEntity(HttpMultipartMode.BROWSER_COMPATIBLE,null,Charset.forName("UTF-8"));
			...
			Log.i("MICROSITIOS", "multipart " + reqEntity.toString());
			...
			/*
			 * 
			 * 12-03 11:19:58.361: I/MICROSITIOS(612): respuesta servicio
			 * {"respuesta"
			 * :{"entidad":"Dermatologico","primernombre":"Sdff","segundonombre"
			 * :"" ,"primerapellido":"Dfggh","segundoapellido":"","email":
			 * "fghh@sdghh.dggg","tipo_solicitud":"5"
			 * ,"descripcion":"Uhdjdjjdjd djjdjsjs djsjjskaks dnksjd"
			 * ,"codigo":"KWFX7787", "webservice":
			 * "http:\/\/www.dermatologia.gov.co\/pruebas\/mobile\/WS.php","vulnerable":"1",
			 * "tipo_documento"
			 * :"1","documento":"23456","departamento":"0","municipio"
			 * :"0","direccion":"Ggggg","telefono":"",
			 * "celular":"45866","asunto"
			 * :"","estado":"Abierto","adjunto":"108","medio_recepcion"
			 * :"ANDROID","medio_respuesta":""
			 * ,"simcard":"8957123310527320186","imei"
			 * :"868497011765889","hecho":
			 * "","nombre_tipo_identificacion":"C\u00e9dula de ciudadan\u00eda",
			 * "nombre_tipo_solicitud"
			 * :"SUGERENCIA","nombre_vulnerable":"Ninguno"
			 * ,"nombre_municipio":"-- Municipios --","nombre_departamento":" --
			 * Departamentos
			 * --","codigo_pais":"1","nombre_pais":"Colombia","codigoAsuntoSolicitud
			 * ":"","codigoTipoCanalSolicitud":"4"
			 * ,"codigoTipoCanalRespuesta":"1"
			 * ,"codigoEntidad":"4","siglaEntidad"
			 * :"CDFLA","numeroTelefonicoDispositivo":"","iddato":null,
			 * "anonimo":null,"respuesta":null, "idgcm":
			 * "APA91bGXHL4CLtaTUH-5zZCW-TG1TFPY39FV7vEryp9WaYuDiZTWpvzzp2NNiE_0g1mclMCkVUmypy-YZOh0bdk63LbcUIrCTVOwywMGsyUYlCgsNm3_FqN2y6JR1T0Wdgew1QMmQ_80YLaLjjgq37r5jXgmHhQfYg"
			 * ,"latitud":"",
			 * "longitud":"","enviocorreo":1,"enviosms":1,"enviogcm"
			 * :1,"fecha":"2014-12-03 11:18:44"
			 * ,"fecha_modificacion":"2014-12-04 11:18:44","llave":"1"},
			...
			Log.i("MICROSITIOS", "respuesta servicio" + xmlRespuesta.toString());
			Log.i("MICROSITIOS", "6");

		} catch (Exception e) {

			Log.i("MICROSITIOS", "ERROR " + e.toString());
	...
	public static void setXmlRespuesta(String xmlRespuesta) {
		AsyncCallWSLog.xmlRespuesta = xmlRespuesta;
	}
